...
sys.path.insert(0, r'/home/kvasudev/software/femus/applications/zzz_sandbox')

####################################################
##       Begin of NoteBook variables section      ##
####################################################
notebook.set("l_x", 1)      # Length in x-direction
notebook.set("l_y", 1)      # Length in y-direction
notebook.set("n_x", 4)      # Number of divisions along x squares total
notebook.set("n_y", 4)      # Number of divisions along y
notebook.set("x_b", -0.5)   # Domain start x
notebook.set("x_e", "x_b + l_x")
notebook.set("y_b", -0.5)   # Domain start y
